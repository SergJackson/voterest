...
public class VoteTestData {
    ...
    public static final Vote vote_1 = new Vote(USER_VOTE_ID + 0, getDate("2021-05-01T07:21:00"));
    public static final Vote vote_2 = new Vote(USER_VOTE_ID + 1, getDate("2021-05-01T09:10:00"));
    public static final Vote vote_3 = new Vote(USER_VOTE_ID + 2, getDate("2021-05-01T10:12:00"));
    public static final Vote vote_4 = new Vote(USER_VOTE_ID + 3, getDate("2021-05-01T10:13:00"));
    public static final Vote vote_5 = new Vote(USER_VOTE_ID + 4, getDate("2021-05-01T12:13:01"));

    public static final Vote vote_6 = new Vote(ADMIN_VOTE_ID + 0, getDate("2021-05-01T06:23:00"));
    public static final Vote vote_7 = new Vote(ADMIN_VOTE_ID + 1, getDate("2021-05-01T10:14:00"));
    public static final Vote vote_8 = new Vote(ADMIN_VOTE_ID + 2, getDate("2021-05-01T11:00:01"));
    ...
    public static Vote getNew() {
        return new Vote(null, getDate("2021-05-01 10:33:33"));
    }

    public static Vote getUpdated() {
        return new Vote(USER_VOTE_ID, getDate("2021-05-01 05:05:05"));
    }
